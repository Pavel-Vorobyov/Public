...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../css/teacher/teaching-course.css">
            ...
            <div class="group-header-wrapper">
              <ul class="uui-item-list">
                <li class="item-body-header">
                  <h2 class="name-item">Название курса:</h2>
                  <h2 class="region-item">Место проведения:</h2>
                  <h2 class="lng-item">Язык:</h2>
                </li>
                <li class="item-body">
                  <span class="group-name" title="Lolli"><a href="#">:dsdfsfadasdasdadadasdasdasdadasdasdadsdadsadadadasdasdasdadsd</a></span>
